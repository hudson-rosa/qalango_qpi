class Constants:
    ...
    class FieldText:
        ...
        ADD_STEP = "+ Add Step"
        API = "API"
        BALANCE_OF_TESTS_PER_SUITE = "Balance of tests per suite"
        BDD_SCENARIO_FORMAT = "BDD Scenario format"
        CATEGORIES_SELECTED = "Categories selected"
        CHART_TEST_EFFORT_DISTRIBUTION = "Test Effort Distribution"
        CHART_TEST_PYRAMID = "Test Pyramid"
        CHART_TOTAL_TIME_OF_MANUAL_TESTING = "Total Time of Manual testing"
        ...
        PERFORMANCE = "Performance"
        PLEASE_SELECT_A_PROJECT_TO_VIEW_CHART = "Please select a project to view the chart."
